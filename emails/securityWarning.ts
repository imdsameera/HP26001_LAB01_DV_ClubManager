...
This is a security alert from Teamnode Club Manager.
...
Teamnode Club Manager Security`;
  ...
  const html = buildHtml({
    ...
    bodyHtml: `
      ...
      <p>An admin account password was changed on your Teamnode Club Manager system:</p>
    ...
    `,
    footerNote: "This is an automated security alert from Teamnode Club Manager. Only Super Admins receive this email.",
    accentColor: "#dc2626",
  });
