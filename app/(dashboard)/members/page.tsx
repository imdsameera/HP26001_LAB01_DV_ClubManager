...
// Seed data
const SEED: Member[] = [
  { id: "1", name: "Nimal S. Perera",     initials: "NP", nic: "198812345678", phone: "+94 71 987 6543", role: "President",     avatarBg: "bg-violet-100", avatarText: "text-violet-700" },
  { id: "2", name: "Ayesha R. Fernando",  initials: "AF", nic: "200156789012", phone: "+94 76 555 3210", role: "Secretary",     avatarBg: "bg-emerald-100", avatarText: "text-emerald-700" },
  { id: "3", name: "Kasun M. Bandara",    initials: "KB", nic: "199034567891", phone: "+94 70 444 2200", role: "Treasurer",     avatarBg: "bg-amber-100",  avatarText: "text-amber-700" },
];
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-400">
            Manage the club's member directory and assign roles.
          </p>
        </div>
                ...
                <tr key={m.id} className="transition-colors hover:bg-gray-50/60">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-xs font-bold ${PALETTE[idx % PALETTE.length].bg} ${PALETTE[idx % PALETTE.length].text}`}
                      >
                        {m.initials}
                      </div>
                      <div>
                  ...
                  <td className="px-6 py-4">
                    <div className="relative inline-flex items-center">
                      <select
                        ...
                        className={`
                          h-7 appearance-none rounded-full border-0 py-0 pl-3 pr-7
