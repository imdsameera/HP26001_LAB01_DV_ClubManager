...
function DashboardContent() {
  ...
  const [selectedApplicant, setSelectedApplicant] = useState<PendingRow | null>(
    null,
  );
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-800 transition group-hover:text-[#0066FF]">
                            {row.name}
                          </p>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center justify-center rounded-[10px] bg-[#0066FF] px-5 py-2 text-[13px] font-semibold text-white transition hover:bg-blue-700 active:scale-95"
                        >
                          Approve
                        </button>
                        <button
                          ...
                          className="flex items-center justify-center rounded-[10px] bg-red-100 px-5 py-2 text-[13px] font-semibold text-red-600 transition hover:bg-red-200 active:scale-95"
                        >
                          Reject
                        </button>
                      </div>
