...
export default function JoinPendingPage({ params }: { params: Promise<{ handle: string }> }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#F8FAFC] px-4">
      ...
      <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-[20px] bg-emerald-100 ring-10 ring-emerald-50 shadow-inner">
        <CheckCircle2
          size={40}
          strokeWidth={2.5}
      ...
      <div className="mt-4 px-2">
        <p className="text-[15px] leading-relaxed text-gray-500">
          Your membership application is currently under review. Administrative
          teams usually process requests within{" "}
